    ...
    public partial class MemberCommision : Form
    {
        ...
        private void backgroundWorker2_DoWork(object sender, DoWorkEventArgs e)
        {
             try
            {
               ...
               ((MemberAgreementNo.Text.Trim() =="")? "null" : MemberAgreementNo.Text.Trim()) +","+ ((Sequence.Text.Trim() == "") ? "null" : Sequence.Text.Trim())+"," + ((Include.CheckState == CheckState.Checked) ? 1 : 0) + "").DefaultView;
