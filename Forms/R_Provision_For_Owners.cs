    ...
    public partial class R_Provision_For_Owners : Form
    {
        ...
        private void bExport1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                contractview = SQLCMD.SQLdata($"exec LS_REPORT_PROVISION_OWNER '{(Contractdate1.Text == "" ? "01-01-1990": Contractdate1.Text)}','{(Contractdate2.Text == "" ? "12-31-2050" : Contractdate2.Text)}'," +
