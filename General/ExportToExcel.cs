                      ...
                      if (DV.Table.Rows[i]["EvoStatus2"].ToString() != "-1") /*tenia uno para que solo exportara los activo pero conan dijo que federico queria que salieran todos los status*/
                        {
                            ...
                            "\t\t" + "<Hotel> " + ((IsNull == true) ? "" : DV.Table.Rows[i]["Property"].ToString()) + "</Hotel>" + "\r\n" +
                            ...
                            "\t\t" + "<NumCont>" + ((IsNull == true) ? "" : DV.Table.Rows[i]["agreementnumber"].ToString()) + "</NumCont>" + "\r\n" +
                            "\t\t" + "<Nombre>" + ((IsNull == true) ? "" : DV.Table.Rows[i]["Comprador1"].ToString()) + "</Nombre>" + "\r\n" +
                            "\t\t" + "<Direccion>" + ((IsNull == true) ? "" : DV.Table.Rows[i]["Address"].ToString()) + "</Direccion>" + "\r\n" +
                            "\t\t" + "<Cuidad>" + ((IsNull == true) ? "" : DV.Table.Rows[i]["city"].ToString() )+ "</Cuidad>" + "\r\n" +
                            "\t\t" + "<Provincia>" + ((IsNull == true) ? "" : DV.Table.Rows[i]["State"].ToString() )+ "</Provincia>" + "\r\n" +
                            "\t\t" + "<CodPostal>" + ((IsNull == true) ? "" : DV.Table.Rows[i]["zip"].ToString()) + "</CodPostal>" + "\r\n" +
                            "\t\t" + "</Comprador>" + "\r\n";
